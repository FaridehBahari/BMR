...
for cohort in cohorts:
    ...
    command = f'python -u run_eMET.py {modified_ini_path} ../external/BMR/procInput/ann_PCAWG_ID_complement.csv ../external/BMR/output/reviewerComments/{cohort}/GBM/GBM_model.pkl 100'
    subprocess.run(command, shell=True)

# from BMR directory run the following command:
# nohup python -u run_eMET_allCohorts.py > ../run_allCohorts_eMET &
