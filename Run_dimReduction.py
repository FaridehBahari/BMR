...
path_save = '../external/procInput/AEreduced_bs64_2000Ep_dim148/'
...
new_reduced_test.to_csv(f'{path_save}test_AEreduced.tsv', sep = '\t')
new_reduced_train.to_csv(f'{path_save}train_AEreduced.tsv', sep = '\t')
