...
val_size = 800
path_var_intervals_responseTab = '../external/BMR/rawInput/responseTabs/Pan_Cancer/responseTab_intgnic_intervals.tsv'
var_interval_response = read_response(path_var_intervals_responseTab)
